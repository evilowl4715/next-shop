...
export async function getProducts(limit: number, offset: number, categoryId?: number, priceMin?: number, priceMax?: number): Promise<{ products: Product[], minPrice: number, maxPrice: number }> {
